...
!function (e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.JSONEditor = t() : e.JSONEditor = t() }(window, function () {
    ...
    e.exports = function () {
        ...
        "use strict"; e.exports = function (e, t, i) {
            var n = " ", r = e.level, o = e.dataLevel, s = e.schema[t], a = e.schemaPath + e.util.getProperty(t), l = e.errSchemaPath + "/" + t, c = !e.opts.allErrors, h = "data" + (o || ""), d = "errs__" + r, u = e.util.copy(e); u.level++; var f = "valid" + u.level; if (n += "var " + d + " = errors;", e.opts.strictKeywords ? "object" == typeof s && 0 < Object.keys(s).length : e.util.schemaHasRules(s, e.RULES.all)) {
            ...
            } return c && (n += "  if (" + d + " == errors) {"), n = e.util.cleanUpCode(n)
        }
